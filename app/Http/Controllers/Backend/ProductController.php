...
class ProductController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = Product::query() //variabel data yg menampung semua data dr tabel product dari model product
           //->with('user')
            ->get(); //memanggil semua data 
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([ //semua yg diinput harus di validasi 
            'title' => 'required', //wajib diisi
            'harga' => 'required|numeric', //wajib diisi dengan angka
            'image' => 'required|image|mimes:jpg,png,jpeg', //wajib diisi berupa gambar format jpg png jpeg
        ...
        $imageName = time() . '.' . $request->image->extension(); //akan mengubah nama gambar menjadi format time dan tetap membaca format gambarnya
        //dd($imageName);
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($id) //parameter id angka yg di link
    {
        # membuat variabel untuk menampung data produk dari where by Id
        $data = Product::find($id); //variabel data
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $id) //parameter request dan id
    {
        ...
        $request->validate([
            ...
            'image' => 'image|mimes:jpg,png,jpeg', //tidak required krn bisa ganti sama gambar atau cuma teks
            'status' => 'required',
            'desc' => 'required'
        ], [
            'title.required' => 'Wajib di isi',
